...
task(
	'swapNativeForNative',
	'swap native on one chain thru StargateComposed to native on another chainr',
...
task('getSigners', 'show the signers of the current mnemonic', require('./getSigners')).addOptionalParam(
	'n',
	'how many to show',
	3,
	types.int
...
task('approveERC1155', 'approve it to transfer my nfts', require('./approveERC1155')).addParam(
	'addr',
